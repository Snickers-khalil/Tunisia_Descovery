    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(HomeFragment.this ,AddActivity.class);
                startActivity(i);
            }
        });
        ...
        pd.setMessage("Fetching Smartphones...");
        ...
        try{
            ...
            call.enqueue(new Callback<List<Livre>>() {
                ...
                public void onResponse(Call<List<Livre>> call, Response<List<Livre>> response) {
                    ...
                    LiverAdapter adapter=new LiverAdapter(HomeFragment.this,LivreList);
                ...
                public void onFailure(Call<List<Livre>> call, Throwable t) {
                    ...
                    Toast.makeText(HomeFragment.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
